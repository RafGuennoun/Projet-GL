...
public class ListeDC extends JFrame {
	...
	public ListeDC() {
		...
		JLabel lblListeDesAdministrateurs = new JLabel("Liste des directeurs commmerciaux :");
		...
		if(cont.listeDC.isEmpty())
		{
			textArea.append("Liste Vide !!");
		}
		else
		{
			for(int i=0; i<cont.listeDC.size() ; i++)
			{
				textArea.append((i+1)+")"+" "+  cont.listeDC.get(i).toString());
			}
		}
